...
<body>
    ...
    <div class="MainMenu">
        ...
        <input type="Number" hidden="true" id="ColleagueCodeRandom" placeholder="Enter Code"> 
        ...
        <button hidden="true" class="ColleagueNumberLoginWithCode">Login</button> <span class="" id="ServerResponse"></span>
